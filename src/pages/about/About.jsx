  ...
  return (
    <div ref={ref} className={Style.aboutContainer}>
      <div className={Style.letter}>         
        ...
        <p className={Style.sentence}>Despite having a formal education in a different field, I have always been passionate about technology and have taught myself web development over the past year through massive open online courses and online resources.</p>
        ...
        <p>I am excited to bring my passion and skills to a project where I can grow and make a meaningful impact.</p>
      </div>
      <div className={Style.contact}>
        ...
        <div className={Style.infoWrapper}>
          ...
          <p>GitHub : <a href="https://github.com/ClementBauduin" target="_blank">https://github.com/ClementBauduin</a></p>
        </div>
      </div>
    </div>
  )
